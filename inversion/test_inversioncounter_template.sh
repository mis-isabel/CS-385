...
run_test_with_args_and_input "slow" "7, 3, 5, 6, 4, 2, 1" "Enter sequence of integers, each followed by a space: Number of inversions: 17"
run_test_with_args_and_input "slow" "1 30 7 5 6" "Enter sequence of integers, each followed by a space: Number of inversions: 5"
...
run_test_with_args_and_input "" "7, 3, 5, 6, 4, 2, 1" "Enter sequence of integers, each followed by a space: Number of inversions: 17"
run_test_with_args_and_input "" "1 30 7 5 6" "Enter sequence of integers, each followed by a space: Number of inversions: 5"
